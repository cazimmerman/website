...
I am a neuroscientist studying how the <strong>brain</strong> senses the physiological state of the <strong>body</strong> and uses that information control <strong>behavior</strong>. The main goals of my research are to discover and characterize new body-to-brain sensory signals and to identify the neural coding mechanisms that link these interoceptive signals to learning and motivation.
