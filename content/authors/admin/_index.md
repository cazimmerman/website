...
I study how <strong>interoceptive signals</strong> from the body modify <strong>brainwide neural circuitry and dynamics</strong> to support <strong>learning and memory</strong> and promote long-lasting changes in behavior, with the goal of understanding the general principles for how learning algorithms are implemented in the brain.
