...
I study how <strong>interoceptive signals from the body</strong> modify <strong>brainwide neural circuitry and representations</strong> in the to support <strong>learning and memory</strong> and promote long-lasting changes in behavior, with the ultimate goal of discovering general principles that govern how learning algorithms are implemented in the brain.
